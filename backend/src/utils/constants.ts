...
export const ADD_USER_PAGE_FILE_PATH = path.join(__dirname, "../../client/views/pages/add-user.html");
export const SQLITE3_DATABASE_PATH = path.join(__dirname, "../db/sqlite3/db/database.db");
